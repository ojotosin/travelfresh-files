...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/file/add" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
								...
								<tr>
									...
									<td class="w-180">
										...
										<?php elseif( $exp[1] == 'pdf' || $exp[1] == 'PDF' ): ?>
											...
											<img src="<?php echo base_url(); ?>public/admin/img/pdf.png" alt="<?php echo $row['file_title']; ?>" style="width:120px;">

										<?php elseif( $exp[1] == 'doc' || $exp[1] == 'DOC' || $exp[1] == 'docx' || $exp[1] == 'DOCX' ): ?>

											<img src="<?php echo base_url(); ?>public/admin/img/docx.png" alt="<?php echo $row['file_title']; ?>" style="width:120px;">

										<?php elseif( $exp[1] == 'xls' || $exp[1] == 'XLS' || $exp[1] == 'xlsx' || $exp[1] == 'XLSX' ): ?>

											<img src="<?php echo base_url(); ?>public/admin/img/xlsx.png" alt="<?php echo $row['file_title']; ?>" style="width:120px;">

										<?php elseif( $exp[1] == 'csv' || $exp[1] == 'CSV' ): ?>

											<img src="<?php echo base_url(); ?>public/admin/img/csv.png" alt="<?php echo $row['file_title']; ?>" style="width:120px;">	
