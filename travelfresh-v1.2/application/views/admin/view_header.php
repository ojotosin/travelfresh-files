...
$settings = $CI->Model_common->get_setting_data();
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?php echo base_url(); ?>admin/dashboard" class="logo">
				<span class="logo-lg"><?php echo $settings['website_name']; ?></span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($class_name == 'traveller') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/traveller">
			            <i class="fa fa-plane"></i> <span>Traveller</span>
			          </a>
			        </li>

			        <li class="treeview <?php if( ($class_name == 'destination') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/destination">
			            <i class="fa fa-map-signs"></i> <span>Destination</span>
			          </a>
			        </li>

			        <li class="treeview <?php if( ($class_name == 'package') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/package">
			            <i class="fa fa-random"></i> <span>Package</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php if( ($class_name == 'service') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/service">
			            <i class="fa fa-bars"></i> <span>Service</span>
			          </a>
			        </li>

			        <li class="treeview <?php if( ($class_name == 'payment') ) {echo 'active';} ?>">
