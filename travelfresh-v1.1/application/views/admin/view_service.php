						...
						<tbody>
							...
							foreach ($service as $row) {
								...
								<tr>
									...
									<td style="width:300px;"><img src="<?php echo base_url(); ?>public/uploads/<?php echo $row['banner']; ?>" alt="<?php echo $row['name']; ?>" style="width:200px;"></td>
									<td><i class="<?php echo $row['icon']; ?>" style="font-size:50px;"></i></td>
									<td>
