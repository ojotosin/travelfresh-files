	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'admin/team_member/edit/'.$team_member['id'],array('class' => 'form-horizontal')); ?>
				...
				<input type="hidden" name="current_banner" value="<?php echo $team_member['banner']; ?>">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<img src="<?php echo base_url();; ?>public/uploads/<?php echo $team_member['banner']; ?>" alt="Team Member Banner" style="width:200px;">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea class="form-control" id="editor1" name="detail"><?php echo $team_member['detail']; ?></textarea>
							</div>
						</div>
						<div class="form-group">
