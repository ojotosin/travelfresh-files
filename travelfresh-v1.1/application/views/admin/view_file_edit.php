			...
			<?php echo form_open_multipart(base_url().'admin/file/edit/'.$file['file_id'],array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">File Preview</label>
							<div class="col-sm-9" style="padding-top:5px;">
								...
								<?php elseif( $exp[1] == 'pdf' || $exp[1] == 'PDF' ): ?>
									...
									<img src="<?php echo base_url(); ?>public/admin/img/pdf.png" alt="<?php echo $file['file_title']; ?>" style="width:120px;">

								<?php elseif( $exp[1] == 'doc' || $exp[1] == 'DOC' || $exp[1] == 'docx' || $exp[1] == 'DOCX' ): ?>

									<img src="<?php echo base_url(); ?>public/admin/img/docx.png" alt="<?php echo $file['file_title']; ?>" style="width:120px;">

								<?php elseif( $exp[1] == 'xls' || $exp[1] == 'XLS' || $exp[1] == 'xlsx' || $exp[1] == 'XLSX' ): ?>

									<img src="<?php echo base_url(); ?>public/admin/img/xlsx.png" alt="<?php echo $file['file_title']; ?>" style="width:120px;">

								<?php elseif( $exp[1] == 'csv' || $exp[1] == 'CSV' ): ?>

									<img src="<?php echo base_url(); ?>public/admin/img/csv.png" alt="<?php echo $file['file_title']; ?>" style="width:120px;">	
